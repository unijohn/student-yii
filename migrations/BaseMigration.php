...
class BaseMigration extends Migration
{
   ...
   static function getWorkDeskTableName( $index = -1 )
   {
      return self::tbl_WorkDeskNames[$index];
   }


   static function getTblCoursesName()
   {
      return self::getWorkDeskTableName(0);
   }
   
   
   static function getTblCoursesCodesChildName()
   {
      return self::getWorkDeskTableName(1);
   }
   
   static function getTblSystemCodesName()
   {
      return self::getWorkDeskTableName(2);
   }      


   static function getTblSystemCodesChildName()
   {
      return self::getWorkDeskTableName(3);
   }


   static function getTblTempAuthAssignmentName()
   {
