...
class m200821_143444_tbl_FormFields extends BaseMigration
{
    ...
    public function safeUp()
    {
        ...
        [
            ...
            // is_yes_no
            [
                self::TYPE_FIELD_SELECT, self::TYPE_YES_NO, 'Is-Yes-No', 'Select Status', '', self::TYPE_PROMPT_DEFAULT, self::STATUS_ACTIVE, self::STATUS_VISIBLE, 1, $created_at,
            ],
            [
                self::TYPE_FIELD_SELECT, self::TYPE_YES_NO, 'Is-Yes-No', 'No',            '', self::TYPE_YES_NO_NO,      self::STATUS_ACTIVE, self::STATUS_VISIBLE, 2, $created_at,
            ],
            [
                self::TYPE_FIELD_SELECT, self::TYPE_YES_NO, 'Is-Yes-No', 'Yes',           '', self::TYPE_YES_NO_YES,     self::STATUS_ACTIVE, self::STATUS_VISIBLE, 3, $created_at,
            ],
