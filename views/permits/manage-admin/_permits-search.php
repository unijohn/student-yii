...
<div class="users-search">
   ...
   <div class="form-group field-code">
      ...
      <?= Html::input('text', 'SystemCodes[code]', $filterForm['code'], 
         [
            'id'     => 'code', 
            'class'  => 'form-control',
   ...
   <label class="control-label" for="is_active">Is Active</label>
      <?= Html::dropDownList('SystemCodes[is_active]', $filterForm['is_active'], 
         $isActive,
         [
            'id'     => 'is_active',
            'class'  => 'form-control',
   ...
   <label class="control-label" for="is_hidden">Is Hidden</label>
      <?= Html::dropDownList('SystemCodes[is_hidden]', $filterForm['is_hidden'], 
         $isHidden,
         [
            'id'     => 'is_hidden',
            'class'  => 'form-control',
   ...
   <label class="control-label" for="is_tagged">Is Tagged</label>
      <?= Html::dropDownList('SystemCodes[is_tagged]', $filterForm['is_tagged'], 
         $isTagged,
         [
            'id'     => 'is_tagged',
            'class'  => 'form-control',
   ...
   <label class="control-label" for="pagination_count"># per Page</label>
      <?= Html::dropDownList('SystemCodes[pagination_count]', $filterForm['pagination_count'], 
         $pageCount,
         [
            'id'     => 'pagination_count',
            'class'  => 'form-control',
